...
public class C7_FileExist {
    ...
    public static void main(String[] args) {
       ...
       String filePath = "\\src\\test\\java\\re\\fileExist\\fileExist.jpg"; // Bulmak istedigimiz dosyanin proje klasorunden sonraki yolunu aldik (Copy path from content root)
